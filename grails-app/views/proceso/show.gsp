...
<html>
    ...
    <body>
        ...
        <div id="show-proceso" class="content scaffold-show" role="main">
            ...
            <f:display bean="proceso" />
            <g:form resource="${this.proceso}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.proceso}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
